...
import {
    ...
    MusicNote as TikTokIcon // TikTok alternative
...
const HomePage = () => {
    ...
    const socialLinks = [
        { icon: GitHubIcon, url: 'https://github.com/andre806', label: 'GitHub', color: '#333' },
        { icon: LinkedInIcon, url: 'https://www.linkedin.com/in/andr%C3%A9-code-9b7646373', label: 'LinkedIn', color: '#0077B5' },
        { icon: WhatsAppIcon, url: 'https://wa.me/5583991779519', label: 'WhatsApp', color: '#25D366' },
        { icon: EmailIcon, url: 'mailto:acode775@gmail.com', label: 'Email', color: '#EA4335' },
        { icon: YouTubeIcon, url: 'https://www.youtube.com/@Andr%C3%A9code-w5z', label: 'YouTube', color: '#FF0000' },
        { icon: InstagramIcon, url: 'https://www.instagram.com/andre_code1/', label: 'Instagram', color: '#E1306C' },
        { icon: TikTokIcon, url: 'https://www.tiktok.com/@andre_code0', label: 'TikTok', color: '#000000' }
    ]
